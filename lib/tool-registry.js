...
const TOOLS = {
  ...
  run_shell: function (params) {
    ...
    // NOTE: Callers should validate that `command` is in their blueprint's
    // allowed_commands list before invoking executeTool('run_shell', ...).
    // This registry executes exactly what is passed — no shell expansion.
...
module.exports = { executeTool, listTools, getContext };
